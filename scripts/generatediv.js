function generatediv(name, location, buildYear, summary, mapsLink, wikiLink, britannicaLink, tripadvisorLink, imageLink) {
    ...
    const iconSources = [
        { href: mapsLink, src: "assets/maps.png", alt: "mapsicon", class: "mapsref clickicon" },
        { href: wikiLink, src: "assets/wikipedia.png", alt: "wikiicon", class: "wikiref clickicon" },
        { href: britannicaLink, src: "assets/britannica.png", alt: "britannicaicon", class: "britannicaref clickicon" },
        { href: tripadvisorLink, src: "assets/tripadvisor.png", alt: "tripadvisoricon", class: "tripadvisorref clickicon" }
    ];
